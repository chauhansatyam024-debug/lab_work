...
int main() {
    ...
    else if (num == 4) {mergesort(arr,0,n-1);for (int i = 0; i<n ;i++){std::cout<<arr[i]<<" ";}}
    else if (num >=5){quickSort_1(arr,0,n-1);for (int i = 0 ;i<n ; i++){std::cout<<arr[i]<<" ";}}
